...
import { Col, ConfigProviderProps, Form, Input, Row, Select, Table, TableColumnsType, DatePicker, Space, Card, Button, Flex, Divider } from 'antd';
...
const FormStudent9_2: React.FC = () => {
    ...
    return (
        ...
        <>
            <Row className="ms-5">
                <Col span={6}><label>週 案 と 保 育 日 誌（以上児）</label></Col>
            </Row>
            <Row className="ms-5 mt-5">
                <Col  span={3}></Col>
                    <FormMonth/>
                <Col  className="text-start pt-1 ms-1"><label>月</label></Col>
            ...
            <Row className="ms-5 mt-3">
                <Col span={2}></Col>
                <Col span={3}><label>週のねらい</label></Col>
                <Col span={8}><TextArea rows={4} maxLength={6} /></Col>
            </Row>
            <Row className="ms-5 mt-3">
                <Col span={2}></Col>
                <Col span={3}><label>活動予定</label></Col>
                <Col span={8}><TextArea rows={4} maxLength={6} /></Col>
            </Row>
            <Row className="ms-5 mt-3">
                <Col span={2}></Col>
                <Col span={3}><label>環境構成と留意点</label></Col>
                <Col span={8}><TextArea rows={4} maxLength={6} /></Col>
            </Row>
            ...
            <Row className="ms-5 mt-3">
                ...
                <Col span={2} className='ms-10'><Input type="text" suffix="天候"/></Col>
            </Row>
            ...
            <Row className="ms-3 mt-3">
                <Col span={2}></Col>
                <Col span={3}  className='text-end '><label>個 人 記 録</label></Col>
                <Col span={8}  className='ms-2 '><TextArea rows={4} maxLength={6} /></Col>
            </Row>
