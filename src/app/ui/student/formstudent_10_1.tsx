...
import { Col, Input, Row, Card, Button, Radio } from 'antd';
...
const FormStudent10_1: React.FC = () => {
    ...
    return (
        ...
        <>
            <Row className="ms-2 mt-3">
                ...
                <Col span={1} className='ms-10 pt-1 '><span>1 歳</span></Col>
            ...
            <Row className="ms-5 mt-3">
                <Col span={15}>
                    <Card style={{ width: '100%' }}>
                        ...
                        <Row className="ms-10 mt-3">
                            <Col span={4}><label>その他の記録</label></Col>
                            <Col span={10}><TextArea rows={4} maxLength={6} /></Col>
                        </Row>
                    </Card>
...
export default FormStudent10_1;
