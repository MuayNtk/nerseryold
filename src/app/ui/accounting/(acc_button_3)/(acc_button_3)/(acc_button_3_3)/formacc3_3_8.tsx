  ...
  return (
    <>
      ...
      <Card>
            ...
            <Table.Summary fixed>
              <Table.Summary.Row>
                ...
                <Table.Summary.Cell index={8}>
                  <InputNumber disabled addonAfter="円" />
                </Table.Summary.Cell>
              ...
              <Table.Summary.Row>
                <Table.Summary.Cell index={0} colSpan={9} align="center">
                  加算による賃金改善のうち、基本給及び決まって毎月支払う手当によるものの割合※7
                </Table.Summary.Cell>
                ...
                <Table.Summary.Cell index={11}>
                  <Input disabled defaultValue={"OK"} />
                </Table.Summary.Cell>
              </Table.Summary.Row>
            </Table.Summary>
          )}
        ...
        <Text type="secondary">
          ※6
          備考欄には、賃金改善実施期間中の採用や退職がある場合にはその旨、また、賃金改善額が他の職員と比較して高額(低額、賃金改善を実施しない場合も含む)である場合についてはその理由を記入すること。
        </Text>{" "}
        <br />
        <Text type="secondary">
          ※7
          「加算Ⅲによる賃金改善見込額」に占める「基本給及び決まって毎月支払う手当による金額」の割合が３分の２以上であることが必要。法定福利費等の事業主負担額を除く。
        </Text>{" "}
        <br />
      </Card>
    </>
