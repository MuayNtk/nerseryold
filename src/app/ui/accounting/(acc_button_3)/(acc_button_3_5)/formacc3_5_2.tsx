  ...
  return (
    <>
      ...
      <Card title="加算の要件について">
        <Card title="次の内容について、当てはまる項目を選択すること。">
          <Form>
            <Form.Item label="　職員の職位、職責又は職務内容に応じた勤務条件等の要件及びこれに応じた賃金体系を定め、すべての職員に周知している。">
      ...
      <Card title="加算適用月について">
        <Form>
          <Form.Item label="加算適用開始月を記入して下さい。">
        ...
        <Form {...formItemLayout}>
          ...
          <Form.Item label="②年齢別　児童数">
            ...
            <Form.Item label="保育所" labelCol={{ span: 4}}>
              ...
              <Form.Item label="事務職員雇上加算" labelCol={{ span: 8 }}>
                <Input defaultValue={"該当"} style={{ width: "20%" }} />
              </Form.Item>
              ...
              <Form.Item label="栄養管理加算（配置）" labelCol={{ span: 8 }}>
                <Input defaultValue={"非該当"} style={{ width: "20%" }} />
              </Form.Item>
            </Form.Item>
          </Form.Item>
          ...
          <Form.Item label="④加算対象人数">
            <Form.Item label="人数Ａ（③×１／３）">
              <Input addonAfter="人" defaultValue={5} />
            </Form.Item>
            <Form.Item label="人数Ｂ（③×１／５）">
              <Input addonAfter="人" defaultValue={3} />
            </Form.Item>
          </Form.Item>
        </Form>
        <Text type="secondary">※　②について各月平均の年齢別児童数とする場合は、算出方法を示した書類を添付すること。</Text>
        <br />
        <Text type="secondary">※　③について算出方法を示した書類を添付すること。</Text>
      </Card>
    </>
  );
};

export default Formacc3_5_2;
